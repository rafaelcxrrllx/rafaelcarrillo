...
export const skills = [
  { name: "Technical Troubleshooting", level: 85, category: "IT" },
  { name: "Research", level: 90, category: "Operations" },
  { name: "User Research", level: 90, category: "Research" },
  { name: "Documentation", level: 85, category: "Operations" },
  ...
  { name: "Git & GitHub", level: 80, category: "Development" },
  { name: "Figma", level: 85, category: "Design" },
  { name: "System Administration", level: 65, category: "IT" },
  { name: "Networking Fundamentals", level: 65, category: "IT" },
  { name: "Cloud Fundamentals", level: 60, category: "Cloud" },
];
...
export const projects = [
  
  {
    ...
    team: "Solo",
    caseStudy: {
      overview: "Cargo Liner is a pet and cargo liner business designed to solve one of the most persistent problems in pet travel: getting rid of pet hair. The goal was to design an enterprise-grade experience that allowed users to create custom cargo liners for their vehicle.",
      problem: "Existing platform was outdated and existing custom cargo liner feature was complex — their interfaces were built for internal operations, not for the customers using them daily. Information is buried, status updates are unclear, and tracking steps is a frustrating, manual process. Users needed real-time visibility without needing to decode the interface.",
      research: "I audited major customizable cargo liner platforms to map their UX patterns and identify gaps. I researched user behavior around item customization — when people check, what they're looking for, and what causes anxiety in the process. I studied enterprise dashboard design patterns, focusing on how to present high-density data without sacrificing clarity. The core finding: users want status a streamline process for customizing a product — they need to know at a glance that things are getting selected.",
      process: "I designed around a single principle: hierarchy of urgency. The most time-sensitive information — car make/model, liner package, color — add-ons first. Then I created a card-based UI system that breaks down the pricing into digestible units. Every decision was functional-first, with aesthetics serving clarity.",
      solution: "A custom cargo liner featuring a step-by-step interface with visual status indicators, simplified product cards for pricing details, a search and filter system for managing multiple products, and a clear visual hierarchy. The mobile-friendly interface ensures users can customize cargo liners on the go without losing context.",
      outcome: "The concept demonstrated that complex products can be made readable and intuitive without sacrificing depth. The design established a strong foundation for enterprise dashboard UX, improved the readability of multi-shipment management, and proved my ability to design for data-heavy, systems-level problems.",
    },
  },
...

  {
    ...
    description: "Designed & developed an athletic streetwear brand's eCommerce experience — improving product discovery, mobile shopping, and brand storytelling.",
