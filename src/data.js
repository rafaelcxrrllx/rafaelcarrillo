...
export const projects = [
  {
    id: 1,
    title: "Cargo Liner",
    subtitle: "Custom Cargo Liner Product Experience  (Shopify + Vue)",
    description: "Redesigned the Custom Cargo Liner product experience for an automotive e-commerce site.",
    tags: ["UX Design", "Web Development"],
    image: "/projects/cargoliner.jpg",
    color: "#E8F4F0",
    accent: "#2D6A4F",
    year: "Oct 2025 - Dec 2025",
    link: "#", // link to case study or Figma
  },
  {
    id: 2,
    title: "Dr.Huggins | Pain Psychologist LA",
    subtitle: "Online Portal for Mental Health Clients With Cronic Pain",
    description: "Revamped a private pain psychologist’s website, transforming it into a more empathetic and intuitive user experience.",
    tags: ["UX Design", "Web Development", "Research"],
  ...
  },
  {
    ...
    subtitle: "E-Commerce Athletic Apparel Brand",
    description: "Lead Design & Developer for the Shopify experience of Barrio Athletics, a fitness brans based in south central los angeles.",
    tags: ["UX Design", "Web Development"],
  ...
  //   description: "A brief description of the problem you solved, your role, and the impact it had on users. Keep it concise — 2-3 sentences.",
