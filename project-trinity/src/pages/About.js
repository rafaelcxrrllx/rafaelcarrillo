  ...
  return (
    <div >
      ...
      <div className='bio-content'>
        ...
        <p className='bio-description'>
          With a Bachelor of Science in Informatics and a 
          Minor in Informations and Computer Science from UC Irvine, along with my Specialization in Human-Computer Interaction, I bring a unique perspective 
